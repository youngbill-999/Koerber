...
Feature: IM.013-001: inventory/transaction/chasc - Chasc Separation Criteria
...
Background: 	
	...
	Scenario Outline: IM.013-001-0017: CHASC fails, if separation criteria is invalid
              mandatory separation criterion is not filled in the input → BWM_0004
              separation criterion has invalid value → BWM_0005
              value for separation criterion that is not configured → BWM_0006
  ...
  When CHASC is used to change quantum ="Qu" with stock type ="AV" and lock type ="MALOCK"
	...
	|"0011"|null|"BWM-0004"|
	|null|"0220"|"BWM-0004"|
	#issue#|"XX"|"0220"|"BWM-0005"|
	#issue#|"0011"|"XX"|"BWM-0005"|

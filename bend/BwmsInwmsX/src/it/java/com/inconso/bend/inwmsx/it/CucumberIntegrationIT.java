...
@CucumberOptions(
    ...
    //tags = "@inventory and @chasc and @Melting and @GRdata and @defaultdatabased",
    //tags = "@inventory and @chasc and @Melting and @BBD and @defaultdatabased",
    //tags = "@inventory and @chasc and @complete_change and @defaultdatabased",
    
    //*******//
    tags = "@inventory and @chasc and @input and @defaultdatabased",
    //tags = "@inventory and @chasc and @success and @defaultdatabased",
    
    //*********
    //tags = "@inventory and @chasc and @Splitting and @defaultdatabased",

...
Feature: IM.013-007: inventory/transaction/chasc - Inventory CHASC input validation
...
Scenario Outline: IM.013-001-0031: CHASC Success with condition: InventoryChascInput is filled correctly without batch for an article without batch management
  ...
  When CHASC is used to change quantum ="Qu" with stock type ="AV" and lock type ="MALOCK"
	...
	###########################- 4 -#####################################
	Scenario: IM.013-001-0031: CHASC Success with condition: 

...
public class SlaaDefaultDataChecker {
  ...
  public void verifyFlgFixedLocationIsNotFlagged() {
    assertEquals("0", slAartAsgmt.getSlaaSlArtAsgmtPk().getFlgFixedLocation());
  }
  ...
  private SlaaSlArtAsgmt readRecord(String storageAreaTgt, String storageLocationTgt, String article, String flgFixedLocation) {
    return (slAartAsgmt == null)
        ? slaaSlArtAsgmtRep.findOne(new SlaaSlArtAsgmtPk(generalHelper.getIdSite(), storageAreaTgt, storageLocationTgt, generalHelper.getIdClient(),
            article, flgFixedLocation))
        : slAartAsgmt;
  }
